 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rp;function u2(){return Rp||(Rp=1,function(s){function u(k,H){var W=k.length;k.push(H);e:for(;0<W;){var ye=W-1>>>1,v=k[ye];if(0<h(v,H))k[ye]=H,k[W]=v,W=ye;else break e}}function d(k){return k.length===0?null:k[0]}function o(k){if(k.length===0)return null;var H=k[0],W=k.pop();if(W!==H){k[0]=W;e:for(var ye=0,v=k.length,D=v>>>1;ye<D;){var G=2*(ye+1)-1,L=k[G],$=G+1,de=k[$];if(0>h(L,W))$<v&&0>h(de,L)?(k[ye]=de,k[$]=W,ye=$):(k[ye]=L,k[G]=W,ye=G);else if($<v&&0>h(de,W))k[ye]=de,k[$]=W,ye=$;else break e}}return H}function h(k,H){var W=k.sortIndex-H.sortIndex;return W!==0?W:k.id-H.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;s.unstable_now=function(){return p.now()}}else{var y=Date,E=y.now();s.unstable_now=function(){return y.now()-E}}var x=[],g=[],R=1,C=null,_=3,B=!1,Y=!1,X=!1,q=!1,U=typeof setTimeout=="function"?setTimeout:null,ce=typeof clearTimeout=="function"?clearTimeout:null,I=typeof setImmediate<"u"?setImmediate:null;function fe(k){for(var H=d(g);H!==null;){if(H.callback===null)o(g);else if(H.startTime<=k)o(g),H.sortIndex=H.expirationTime,u(x,H);else break;H=d(g)}}function Z(k){if(X=!1,fe(k),!Y)if(d(x)!==null)Y=!0,Oe||(Oe=!0,ke());else{var H=d(g);H!==null&&qe(Z,H.startTime-k)}}var Oe=!1,De=-1,Be=5,Ne=-1;function F(){return q?!0:!(s.unstable_now()-Ne<Be)}function we(){if(q=!1,Oe){var k=s.unstable_now();Ne=k;var H=!0;try{e:{Y=!1,X&&(X=!1,ce(De),De=-1),B=!0;var W=_;try{t:{for(fe(k),C=d(x);C!==null&&!(C.expirationTime>k&&F());){var ye=C.callback;if(typeof ye=="function"){C.callback=null,_=C.priorityLevel;var v=ye(C.expirationTime<=k);if(k=s.unstable_now(),typeof v=="function"){C.callback=v,fe(k),H=!0;break t}C===d(x)&&o(x),fe(k)}else o(x);C=d(x)}if(C!==null)H=!0;else{var D=d(g);D!==null&&qe(Z,D.startTime-k),H=!1}}break e}finally{C=null,_=W,B=!1}H=void 0}}finally{H?ke():Oe=!1}}}var ke;if(typeof I=="function")ke=function(){I(we)};else if(typeof MessageChannel<"u"){var Dt=new MessageChannel,Ct=Dt.port2;Dt.port1.onmessage=we,ke=function(){Ct.postMessage(null)}}else ke=function(){U(we,0)};function qe(k,H){De=U(function(){k(s.unstable_now())},H)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(k){k.callback=null},s.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Be=0<k?Math.floor(1e3/k):5},s.unstable_getCurrentPriorityLevel=function(){return _},s.unstable_next=function(k){switch(_){case 1:case 2:case 3:var H=3;break;default:H=_}var W=_;_=H;try{return k()}finally{_=W}},s.unstable_requestPaint=function(){q=!0},s.unstable_runWithPriority=function(k,H){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var W=_;_=k;try{return H()}finally{_=W}},s.unstable_scheduleCallback=function(k,H,W){var ye=s.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?ye+W:ye):W=ye,k){case 1:var v=-1;break;case 2:v=250;break;case 5:v=1073741823;break;case 4:v=1e4;break;default:v=5e3}return v=W+v,k={id:R++,callback:H,priorityLevel:k,startTime:W,expirationTime:v,sortIndex:-1},W>ye?(k.sortIndex=W,u(g,k),d(x)===null&&k===d(g)&&(X?(ce(De),De=-1):X=!0,qe(Z,W-ye))):(k.sortIndex=v,u(x,k),Y||B||(Y=!0,Oe||(Oe=!0,ke()))),k},s.unstable_shouldYield=F,s.unstable_wrapCallback=function(k){var H=_;return function(){var W=_;_=H;try{return k.apply(this,arguments)}finally{_=W}}}}(ao)),ao}var kp;function f2(){return kp||(kp=1,to.exports=u2()),to.exports}var lo={exports:{}},Ie={};/**
 * @license React
...
`;function Vg(s){const{name:u,photoUrl:d,profilePicUrl:o,displayName:h,subtitle:p,stats:y,bio:E,metrics:x,project:g,logos:R,contact:C,github:_,logosHeading:B="Built At",rarity:Y,collectorNumber:X}=s,[q,U]=T.useState(!1),[ce,I]=T.useState(!1),fe=T.useRef(null),Z=T.useRef(null);T.useEffect(()=>{const F=window.matchMedia("(prefers-reduced-motion: reduce)");I(F.matches);const we=ke=>I(ke.matches);return F.addEventListener("change",we),()=>F.removeEventListener("change",we)},[]);const Oe=T.useCallback(()=>U(F=>!F),[]),De=F=>{(F.key==="Enter"||F.key===" ")&&(F.preventDefault(),Oe())},Be=F=>{if(ce||!fe.current||!Z.current)return;const we=fe.current.getBoundingClientRect(),ke=(F.clientX-we.left)/we.width,Dt=(F.clientY-we.top)/we.height,Ct=q?-1:1,qe=(.5-Dt)*24*Ct,k=(ke-.5)*24*Ct;Z.current.style.setProperty("--tilt-x",`${qe}deg`),Z.current.style.setProperty("--tilt-y",`${k}deg`);const H=q?1-ke:ke;fe.current.style.setProperty("--mouse-x",`${H*100}%`),fe.current.style.setProperty("--mouse-y",`${Dt*100}%`)},Ne=()=>{!fe.current||!Z.current||(Z.current.style.setProperty("--tilt-x","0deg"),Z.current.style.setProperty("--tilt-y","0deg"),fe.current.style.setProperty("--mouse-x","50%"),fe.current.style.setProperty("--mouse-y","50%"))};return i.jsxs(i.Fragment,{children:[i.jsx("style",{children:Gg}),i.jsxs("div",{ref:fe,className:`tcg-stage ${q?"flipped":""} ${ce?"tcg-reduced":""}`,role:"button",tabIndex:0,"aria-pressed":q,"aria-label":`Card for ${h}. ${q?"Showing back. ":"Showing front. "}Press Enter to flip.`,onClick:Oe,onKeyDown:De,onPointerMove:Be,onPointerLeave:Ne,children:[i.jsx("div",{className:"tcg-flip",children:i.jsxs("div",{className:"tcg-tilt",ref:Z,children:[i.jsx("div",{className:"tcg-face tcg-front",children:i.jsxs("div",{className:"tcg-front-inner",children:[i.jsx("img",{src:d,alt:`${h} portrait`,className:"tcg-photo"}),i.jsx("div",{className:"tcg-photo-vignette"}),i.jsx("div",{className:"tcg-foil tcg-foil-pattern"}),i.jsx("div",{className:"tcg-foil tcg-foil-rainbow"}),i.jsx("div",{className:"tcg-foil tcg-foil-glare"}),i.jsx("div",{className:"tcg-name-vertical","aria-label":u,children:Array.from(u).reverse().map((F,we)=>i.jsx("span",{className:"tcg-name-char",children:F},we))})]})}),i.jsxs("div",{className:"tcg-face back tcg-back",children:[i.jsx("div",{className:"tcg-back-grain"}),Y&&i.jsx("div",{className:"tcg-rarity",children:Y}),X&&i.jsx("div",{className:"tcg-collector",children:X}),i.jsxs("header",{className:"tcg-header",children:[i.jsx("img",{src:o,alt:"",className:"tcg-profile-pic"}),i.jsx("div",{className:"tcg-handle-block",children:i.jsx("div",{className:"tcg-display-name-large",children:h})})]}),p&&i.jsx("div",{className:"tcg-subtitle",children:p}),i.jsx("div",{className:"tcg-stats",children:y.map(F=>i.jsxs("div",{className:`tcg-stat ${F.wide?"wide":""}`,children:[i.jsxs("span",{className:"tcg-stat-label",children:[F.label.toUpperCase(),": "]}),i.jsx("span",{className:"tcg-stat-value",children:F.value})]},F.label))}),i.jsx("p",{className:"tcg-bio",children:E}),i.jsx("div",{className:"tcg-metrics",children:x.slice(0,3).map((F,we)=>i.jsxs("div",{className:"tcg-metric",children:[i.jsx("div",{className:"tcg-metric-value",children:F.value}),i.jsx("div",{className:"tcg-metric-label",children:F.label})]},we))}),g&&i.jsxs(i.Fragment,{children:[i.jsx("div",{className:"tcg-logos-heading",children:"Projects"}),i.jsxs("a",{href:g.url,target:"_blank",rel:"noopener noreferrer",className:"tcg-project",onClick:F=>F.stopPropagation(),children:[i.jsx("img",{src:g.logoUrl,alt:g.name,className:"tcg-project-logo"}),i.jsxs("div",{className:"tcg-project-meta",children:[i.jsx("div",{className:"tcg-project-name",children:g.name}),i.jsx("div",{className:"tcg-project-url",children:g.url.replace(/^https?:\/\//,"").replace(/\/$/,"")})]}),i.jsx("span",{className:"tcg-project-arrow","aria-hidden":!0,children:"↗"})]})]}),i.jsx("div",{className:"tcg-logos-heading",children:B}),i.jsx("div",{className:"tcg-logos",children:R.map(F=>F.src?i.jsx("img",{src:F.src,alt:F.name,className:"tcg-logo"},F.name):i.jsx("span",{className:"tcg-logo-placeholder",children:F.name},F.name))}),i.jsxs("div",{className:"tcg-contact",children:[i.jsxs("a",{href:`mailto:${C}`,onClick:F=>F.stopPropagation(),children:[i.jsx("svg",{viewBox:"0 0 24 24",width:"12",height:"12","aria-hidden":!0,className:"tcg-contact-icon",children:i.jsx("path",{fill:"currentColor",d:"M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"})}),C]}),_&&i.jsxs("a",{href:_,target:"_blank",rel:"noopener noreferrer",onClick:F=>F.stopPropagation(),children:[i.jsx("svg",{viewBox:"0 0 24 24",width:"12",height:"12","aria-hidden":!0,className:"tcg-contact-icon",children:i.jsx("path",{fill:"currentColor",d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})}),_.replace(/^https?:\/\//,"").replace(/\/$/,"")]})]}),i.jsx("div",{className:"tcg-foil tcg-foil-pattern"}),i.jsx("div",{className:"tcg-foil tcg-foil-rainbow"}),i.jsx("div",{className:"tcg-foil tcg-foil-glare"})]})]})}),i.jsx("div",{className:"tcg-hint",children:q?"Tap to flip back":"Tap card to flip"})]})]})}const el="/",Xg={name:"ROSENDO",photoUrl:`${el}me.png`,profilePicUrl:`${el}ro.jpg`,displayName:"Rosendo Inzunza",subtitle:"Systems Engineer",github:"https://github.com/roinzunza",stats:[{label:"Based In",value:"California, US"},{label:"Builds With",value:"Rust + Python"},{label:"Fuel",value:"Oat milk cortado"},{label:"Hobbies",value:"MTG · Gaming · Running",wide:!0}],bio:"Systems engineer with 6 years in infrastructure and systems engineering, most recently at Cloudflare and TikTok. Set technical direction for control planes, ML training systems, and distributed tooling at global scale. Strength is driving architectural changes that span multiple teams, from RFC and stakeholder alignment through production delivery, and unblocking initiatives stalled by scale or blast-radius risk. Also founded and shipped SideQuest, a live iOS marketplace, solo.",metrics:[{value:"6",label:"Years Shipping"},{value:"10×",label:"Faster APIs"},{value:"1",label:"iOS App Live"}],project:{name:"SideQuest",url:"https://www.sidequestapp.io",logoUrl:`${el}icons/wordmark.png`},logosHeading:"Built At",logos:[{name:"Cloudflare",src:`${el}Cloudflare.png`},{name:"TikTok",src:`${el}icons/tiktok-logo-tikok-icon-transparent-tikok-app-logo-free-png.webp`},{name:"DFT",src:`${el}digital_force_technologies.jpg`},{name:"CoreLogic",src:`${el}icons/CoreLogic_logo.svg.png`}],contact:"rosendoinzunza@gmail.com",rarity:"★ Mythic",collectorNumber:"001 / 001 · Founders"},Qg=`
  .tcg-landing {
    position: relative;
    min-height: 100vh;
    width: 100%;
